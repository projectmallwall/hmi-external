import { TetrisComponent } from './components/Tetris-external/Tetris-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, TetrisComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, TetrisComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
