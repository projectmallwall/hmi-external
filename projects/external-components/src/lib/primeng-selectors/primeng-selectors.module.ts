import { HarryPottersResumeComponent } from './components/Harry-Potters-Resume-external/Harry-Potters-Resume-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, HarryPottersResumeComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, HarryPottersResumeComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
