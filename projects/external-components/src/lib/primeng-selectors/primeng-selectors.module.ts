import { ProductIdeasLoggerComponent } from './components/Product-Ideas-Logger-external/Product-Ideas-Logger-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, ProductIdeasLoggerComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, ProductIdeasLoggerComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
