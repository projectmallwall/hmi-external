import { WorkoutTrackerComponent } from './components/WorkoutTracker-external/WorkoutTracker-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, WorkoutTrackerComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, WorkoutTrackerComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
