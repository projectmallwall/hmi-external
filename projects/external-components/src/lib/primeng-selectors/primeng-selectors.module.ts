import { DietTrackerComponent } from './components/Diet-tracker--external/Diet-tracker--external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, DietTrackerComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, DietTrackerComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
