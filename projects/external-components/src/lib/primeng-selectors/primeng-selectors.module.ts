import { RestaurantMenuComponent } from './components/Restaurant-menu-external/Restaurant-menu-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, RestaurantMenuComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, RestaurantMenuComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
