import { CalanderWithNotesComponent } from './components/Calander-with-notes-external/Calander-with-notes-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, CalanderWithNotesComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, CalanderWithNotesComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
