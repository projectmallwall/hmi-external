import { TrafficNinjaComponent } from './components/Traffic-Ninja-external/Traffic-Ninja-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, TrafficNinjaComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, TrafficNinjaComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
