import { Tictactest } from './components/Tictactest-external/Tictactest-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, Tictactest],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, Tictactest],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
