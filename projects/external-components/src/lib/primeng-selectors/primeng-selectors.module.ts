import { InvestmentTrackerComponent } from './components/Investment-tracker-external/Investment-tracker-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, InvestmentTrackerComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, InvestmentTrackerComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
