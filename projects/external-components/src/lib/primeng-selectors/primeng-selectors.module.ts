import { ExpenseSplitterComponent } from './components/Expense-splitter-external/Expense-splitter-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, ExpenseSplitterComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, ExpenseSplitterComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
