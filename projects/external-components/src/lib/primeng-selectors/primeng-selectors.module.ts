import { NotebookComponent } from './components/Notebook-external/Notebook-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, NotebookComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, NotebookComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
